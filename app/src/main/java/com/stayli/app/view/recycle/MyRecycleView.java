...
//        recyclerView.getAdapter().notifyDataSetChanged();
        // 使用局部刷新方法， 将count 设置为当前集合大小 ，间接实现全部刷新并解决闪动问题
     ...
     * @param actAllList
     */
    public void setDateRefresh(List<T> actAllList, List<T> tmp) {
        setDateRefresh(actAllList, tmp, R.drawable.no_image, "无最新数据");
    }
