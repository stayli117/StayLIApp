package net.people.lifecycle_android.bean;
...
public class CityBean {
    ...
    private int code;
    private String msg;
    private List<CityInfoBean> newslist;
    ...
    public List<CityInfoBean> getNewslist() {
        return newslist;
    }

    public void setNewslist(List<CityInfoBean> newslist) {
