...
//        System.out.println("mMenuView:" + mMenuView + " mButtons:" + mButtons + " mOnClickListener" + mOnClickListener);
     ...
     * necessary calls back to the provided {@link CustomBottomNavigation} so that the tab position is
     * kept in sync.
     * <p>
    ...
    private static class BottomNavigationViewExOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<CustomBottomNavigation> mBnveRef;

        public BottomNavigationViewExOnPageChangeListener(CustomBottomNavigation bnve) {
        ...
        public void onPageSelected(final int position) {
            final CustomBottomNavigation bnve = mBnveRef.get();
...
//            Log.d("onPageSelected", "--------- position " + position + " ------------");
    ...
    private static class MyOnNavigationItemSelectedListener implements OnNavigationItemSelectedListener {
        ...
        MyOnNavigationItemSelectedListener(ViewPager viewPager, CustomBottomNavigation bnve, boolean smoothScroll, OnNavigationItemSelectedListener listener) {
