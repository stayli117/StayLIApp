...
public class PairCircleProgressBar extends View {
    private int mWidth;
    private int mHeight;
    ...
    public PairCircleProgressBar(Context context) {
        this(context, null);
    }

    public PairCircleProgressBar(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PairCircleProgressBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
     ...
     * 开启动画
     */
    public PairCircleProgressBar startAnimation() {
        startDrawOk = false;
        startAngle = 0;
        sweepAngle = 20;
        path = new Path();
     ...
     * 取消
     */
    public PairCircleProgressBar cancleAnimation() {
     ...
     * end 结束
     */
    public PairCircleProgressBar endAnimation() {
        if (animatorSet.isRunning()) {
            animatorSet.end();
        }
        return this;
